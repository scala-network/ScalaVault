...
## What is it?
- A **Scala** lightwallet for Android. You get to choose what remote node you want to connect to. No need to download the blockchain.

## What features does it have?

- Seamless XLA.TO integration - instantly pay BTC with XLA using third-party XLA.TO service
...
- Spend Scalaj (handle with care on mainnet!)
...
- QR Code for receiving with conversion of XLA to USD/EUR and back through Kraken API
...
Please contact the friendly people over at http://xmr.to for support - you will need your XLA.TO Secret Key.
...
If you want to use existing wallet files, you need to copy the wallet files from you current Scala client. These are:
```
WalletName
...
- Windows: `%USERPROFILE%\Documents\Scala\wallets`
- Mac: `~/Scala/wallets` (for the GUI) or `~/.bitscala/wallets` for the daemon.
- Linux: `~/.bitscala/wallet`
...
## Why does it make a 'scala' folder?
This is a new feature of scala core to share certain key images with other scala forks.
...
**NB: This feature is for test purposed only - all your XLA will be stolen if you use it!**
