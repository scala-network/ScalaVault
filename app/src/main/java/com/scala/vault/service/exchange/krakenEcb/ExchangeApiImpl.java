...
package com.scala.vault.service.exchange.krakenEcb;

import android.support.annotation.NonNull;

import com.scala.vault.service.exchange.api.ExchangeApi;
import com.scala.vault.service.exchange.api.ExchangeCallback;
import com.scala.vault.service.exchange.api.ExchangeRate;
...
/*
    Gets the XLA/EUR rate from kraken and then gets the EUR/fiat rate from the ECB
 */
...
public class ExchangeApiImpl implements ExchangeApi {
    ...
    public void queryExchangeRate(@NonNull final String baseCurrency, @NonNull final String quoteCurrency,
        ...
        final ExchangeApi krakenApi =
                new com.scala.vault.service.exchange.kraken.ExchangeApiImpl(okHttpClient);
        krakenApi.queryExchangeRate(Helper.BASE_CRYPTO, BASE_FIAT, new ExchangeCallback() {
            ...
            public void onSuccess(final ExchangeRate krakenRate) {
                ...
                final ExchangeApi ecbApi =
                        new com.scala.vault.service.exchange.ecb.ExchangeApiImpl(okHttpClient);
