...
public class Notice {
    ...
    private static final String NOTICE_SHOW_XLATO_ENABLED_LOGIN = "notice_xmrto_enabled_login";
    private static final String NOTICE_SHOW_XLATO_ENABLED_SEND = "notice_xmrto_enabled_send";
