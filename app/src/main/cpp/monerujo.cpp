...
struct MyWalletListener : Bitscala::WalletListener {
    jobject jlistener;
...
Java_com_scala_vault_model_WalletManager_createWalletJ(JNIEnv *env, jobject instance,
    ...
    Scala::NetworkType _networkType = static_cast<Scala::NetworkType>(networkType);

    Bitscala::Wallet *wallet =
            Bitscala::WalletManagerFactory::getWalletManager()->createWallet(
                    std::string(_path),
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_WalletManager_openWalletJ(JNIEnv *env, jobject instance,
                                                          jstring path, jstring password,
                                                          jint networkType) {
    const char *_path = env->GetStringUTFChars(path, NULL);
    const char *_password = env->GetStringUTFChars(password, NULL);
    ...
    Bitscala::Wallet *wallet =
            Bitscala::WalletManagerFactory::getWalletManager()->openWallet(
                    std::string(_path),
                    std::string(_password),
                    _networkType);
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_WalletManager_recoveryWalletJ(JNIEnv *env, jobject instance,
                                                              jstring path, jstring password,
                                                              jstring mnemonic,
                                                              jint networkType,
                                                              jlong restoreHeight) {
    ...
    Bitscala::Wallet *wallet =
            Bitscala::WalletManagerFactory::getWalletManager()->recoveryWallet(
                    std::string(_path),
                    std::string(_password),
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_WalletManager_createWalletFromKeysJ(JNIEnv *env, jobject instance,
                                                                    jstring path, jstring password,
                                                                    jstring language,
                                                                    jint networkType,
                                                                    jlong restoreHeight,
    ...
    Bitscala::Wallet *wallet =
            Bitscala::WalletManagerFactory::getWalletManager()->createWalletFromKeys(
                    std::string(_path),
                    std::string(_password),
                    std::string(_language),
                    _networkType,
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_WalletManager_createWalletFromDeviceJ(JNIEnv *env, jobject instance,
                                                                      jstring path,
                                                                      jstring password,
                                                                      jint networkType,
                                                                      jstring deviceName,
    ...
    Bitscala::Wallet *wallet =
            Bitscala::WalletManagerFactory::getWalletManager()->createWalletFromDevice(
                    std::string(_path),
                    std::string(_password),
                    _networkType,
...
Java_com_scala_vault_model_WalletManager_walletExists(JNIEnv *env, jobject instance,
                                                           jstring path) {
    const char *_path = env->GetStringUTFChars(path, NULL);
    bool exists =
            Bitscala::WalletManagerFactory::getWalletManager()->walletExists(std::string(_path));
    env->ReleaseStringUTFChars(path, _path);
    return static_cast<jboolean>(exists);
}

JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_WalletManager_verifyWalletPassword(JNIEnv *env, jobject instance,
    ...
    const char *_password = env->GetStringUTFChars(password, NULL);
    bool passwordOk =
            Bitscala::WalletManagerFactory::getWalletManager()->verifyWalletPassword(
...
Java_com_scala_vault_model_WalletManager_queryWalletDeviceJ(JNIEnv *env, jobject instance,
                                                                 jstring keys_file_name,
                                                                 jstring password) {
    const char *_keys_file_name = env->GetStringUTFChars(keys_file_name, NULL);
    const char *_password = env->GetStringUTFChars(password, NULL);
    Bitscala::Wallet::Device device_type;
    bool ok = Bitscala::WalletManagerFactory::getWalletManager()->
...
Java_com_scala_vault_model_WalletManager_findWallets(JNIEnv *env, jobject instance,
                                                          jstring path) {
    const char *_path = env->GetStringUTFChars(path, NULL);
    std::vector<std::string> walletPaths =
            Bitscala::WalletManagerFactory::getWalletManager()->findWallets(std::string(_path));
    env->ReleaseStringUTFChars(path, _path);
...
Java_com_scala_vault_model_WalletManager_setDaemonAddressJ(JNIEnv *env, jobject instance,
                                                                jstring address) {
    const char *_address = env->GetStringUTFChars(address, NULL);
    Bitscala::WalletManagerFactory::getWalletManager()->setDaemonAddress(std::string(_address));
    env->ReleaseStringUTFChars(address, _address);
}

// returns whether the daemon can be reached, and its version number
JNIEXPORT jint JNICALL
Java_com_scala_vault_model_WalletManager_getDaemonVersion(JNIEnv *env,
                                                               jobject instance) {
    uint32_t version;
    bool isConnected =
            Bitscala::WalletManagerFactory::getWalletManager()->connected(&version);
    if (!isConnected) version = 0;
    return version;
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_WalletManager_getBlockchainHeight(JNIEnv *env, jobject instance) {
    return Bitscala::WalletManagerFactory::getWalletManager()->blockchainHeight();
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_WalletManager_getBlockchainTargetHeight(JNIEnv *env,
                                                                        jobject instance) {
    return Bitscala::WalletManagerFactory::getWalletManager()->blockchainTargetHeight();
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_WalletManager_getNetworkDifficulty(JNIEnv *env, jobject instance) {
    return Bitscala::WalletManagerFactory::getWalletManager()->networkDifficulty();
}

JNIEXPORT jdouble JNICALL
Java_com_scala_vault_model_WalletManager_getMiningHashRate(JNIEnv *env, jobject instance) {
    return Bitscala::WalletManagerFactory::getWalletManager()->miningHashRate();
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_WalletManager_getBlockTarget(JNIEnv *env, jobject instance) {
    return Bitscala::WalletManagerFactory::getWalletManager()->blockTarget();
}

JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_WalletManager_isMining(JNIEnv *env, jobject instance) {
    return static_cast<jboolean>(Bitscala::WalletManagerFactory::getWalletManager()->isMining());
}

JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_WalletManager_startMining(JNIEnv *env, jobject instance,
                                                          jstring address,
                                                          jboolean background_mining,
                                                          jboolean ignore_battery) {
    const char *_address = env->GetStringUTFChars(address, NULL);
    bool success =
            Bitscala::WalletManagerFactory::getWalletManager()->startMining(std::string(_address),
                                                                             background_mining,
                                                                             ignore_battery);
    env->ReleaseStringUTFChars(address, _address);
...
JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_WalletManager_stopMining(JNIEnv *env, jobject instance) {
    return static_cast<jboolean>(Bitscala::WalletManagerFactory::getWalletManager()->stopMining());
}

JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_WalletManager_resolveOpenAlias(JNIEnv *env, jobject instance,
                                                               jstring address,
                                                               jboolean dnssec_valid) {
    const char *_address = env->GetStringUTFChars(address, NULL);
    bool _dnssec_valid = (bool) dnssec_valid;
    std::string resolvedAlias =
            Bitscala::WalletManagerFactory::getWalletManager()->resolveOpenAlias(
                    std::string(_address),
                    _dnssec_valid);
    env->ReleaseStringUTFChars(address, _address);
...
JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_WalletManager_closeJ(JNIEnv *env, jobject instance,
                                                     jobject walletInstance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, walletInstance);
    bool closeSuccess = Bitscala::WalletManagerFactory::getWalletManager()->closeWallet(wallet,
                                                                                         false);
    if (closeSuccess) {
...
JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getSeed(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return env->NewStringUTF(wallet->seed().c_str());
}

JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getSeedLanguage(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return env->NewStringUTF(wallet->getSeedLanguage().c_str());
}

JNIEXPORT void JNICALL
Java_com_scala_vault_model_Wallet_setSeedLanguage(JNIEnv *env, jobject instance,
                                                       jstring language) {
    const char *_language = env->GetStringUTFChars(language, NULL);
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jint JNICALL
Java_com_scala_vault_model_Wallet_getStatusJ(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jobject JNICALL
Java_com_scala_vault_model_Wallet_statusWithErrorString(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_Wallet_setPassword(JNIEnv *env, jobject instance,
                                                   jstring password) {
    const char *_password = env->GetStringUTFChars(password, NULL);
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getAddressJ(JNIEnv *env, jobject instance,
                                                   jint accountIndex,
                                                   jint addressIndex) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getPath(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return env->NewStringUTF(wallet->path().c_str());
}

JNIEXPORT jint JNICALL
Java_com_scala_vault_model_Wallet_nettype(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getIntegratedAddress(JNIEnv *env, jobject instance,
                                                            jstring payment_id) {
...
JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getSecretViewKey(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return env->NewStringUTF(wallet->secretViewKey().c_str());
}

JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getSecretSpendKey(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return env->NewStringUTF(wallet->secretSpendKey().c_str());
}

JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_Wallet_store(JNIEnv *env, jobject instance,
                                             jstring path) {
    const char *_path = env->GetStringUTFChars(path, NULL);
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getFilename(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_Wallet_initJ(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_Wallet_setRestoreHeight(JNIEnv *env, jobject instance,
                                                        jlong height) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getRestoreHeight(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jint JNICALL
Java_com_scala_vault_model_Wallet_getConnectionStatusJ(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getBalance(JNIEnv *env, jobject instance,
                                                  jint accountIndex) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getBalanceAll(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return wallet->balanceAll();
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getUnlockedBalance(JNIEnv *env, jobject instance,
                                                          jint accountIndex) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getUnlockedBalanceAll(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return wallet->unlockedBalanceAll();
}

JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_Wallet_isWatchOnly(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return static_cast<jboolean>(wallet->watchOnly());
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getBlockChainHeight(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return wallet->blockChainHeight();
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getApproximateBlockChainHeight(JNIEnv *env,
                                                                      jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getDaemonBlockChainHeight(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return wallet->daemonBlockChainHeight();
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getDaemonBlockChainTargetHeight(JNIEnv *env,
                                                                       jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_Wallet_isSynchronizedJ(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return static_cast<jboolean>(wallet->synchronized());
}

JNIEXPORT jint JNICALL
Java_com_scala_vault_model_Wallet_getDeviceTypeJ(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    Bitscala::Wallet::Device device_type = wallet->getDeviceType();
    return static_cast<jint>(device_type);
}

//void cn_slow_hash(const void *data, size_t length, char *hash); // from crypto/hash-ops.h
JNIEXPORT jbyteArray JNICALL
Java_com_scala_vault_util_KeyStoreHelper_slowHash(JNIEnv *env, jclass clazz,
...
JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getDisplayAmount(JNIEnv *env, jclass clazz,
                                                        jlong amount) {
    return env->NewStringUTF(Bitscala::Wallet::displayAmount(amount).c_str());
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getAmountFromString(JNIEnv *env, jclass clazz,
                                                           jstring amount) {
    const char *_amount = env->GetStringUTFChars(amount, NULL);
    uint64_t x = Bitscala::Wallet::amountFromString(_amount);
    env->ReleaseStringUTFChars(amount, _amount);
    return x;
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getAmountFromDouble(JNIEnv *env, jclass clazz,
                                                           jdouble amount) {
    return Bitscala::Wallet::amountFromDouble(amount);
}

JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_generatePaymentId(JNIEnv *env, jclass clazz) {
    return env->NewStringUTF(Bitscala::Wallet::genPaymentId().c_str());
}

JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_Wallet_isPaymentIdValid(JNIEnv *env, jclass clazz,
                                                        jstring payment_id) {
    const char *_payment_id = env->GetStringUTFChars(payment_id, NULL);
    bool isValid = Bitscala::Wallet::paymentIdValid(_payment_id);
    env->ReleaseStringUTFChars(payment_id, _payment_id);
    return static_cast<jboolean>(isValid);
}

JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_Wallet_isAddressValid(JNIEnv *env, jclass clazz,
                                                      jstring address, jint networkType) {
    const char *_address = env->GetStringUTFChars(address, NULL);
    Scala::NetworkType _networkType = static_cast<Scala::NetworkType>(networkType);
    bool isValid = Bitscala::Wallet::addressValid(_address, _networkType);
    env->ReleaseStringUTFChars(address, _address);
    return static_cast<jboolean>(isValid);
}

JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getPaymentIdFromAddress(JNIEnv *env, jclass clazz,
                                                               jstring address,
                                                               jint networkType) {
    Scala::NetworkType _networkType = static_cast<Scala::NetworkType>(networkType);
    const char *_address = env->GetStringUTFChars(address, NULL);
    std::string payment_id = Bitscala::Wallet::paymentIdFromAddress(_address, _networkType);
    env->ReleaseStringUTFChars(address, _address);
    return env->NewStringUTF(payment_id.c_str());
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getMaximumAllowedAmount(JNIEnv *env, jclass clazz) {
    return Bitscala::Wallet::maximumAllowedAmount();
}

JNIEXPORT void JNICALL
Java_com_scala_vault_model_Wallet_startRefresh(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    wallet->startRefresh();
}

JNIEXPORT void JNICALL
Java_com_scala_vault_model_Wallet_pauseRefresh(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    wallet->pauseRefresh();
}

JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_Wallet_refresh(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return static_cast<jboolean>(wallet->refresh());
}

JNIEXPORT void JNICALL
Java_com_scala_vault_model_Wallet_refreshAsync(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    wallet->refreshAsync();
}
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_Wallet_rescanBlockchainAsync(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_createTransactionJ(JNIEnv *env, jobject instance,
    ...
    const char *_payment_id = env->GetStringUTFChars(payment_id, NULL);
    Bitscala::PendingTransaction::Priority _priority =
            static_cast<Bitscala::PendingTransaction::Priority>(priority);
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);

    Bitscala::PendingTransaction *tx = wallet->createTransaction(_dst_addr, _payment_id,
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_createSweepTransaction(JNIEnv *env, jobject instance,
                                                              jstring dst_addr, jstring payment_id,
                                                              jint mixin_count,
                                                              jint priority,
                                                              jint accountIndex) {
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_createSweepUnmixableTransactionJ(JNIEnv *env,
                                                                        jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    Bitscala::PendingTransaction *tx = wallet->createSweepUnmixableTransaction();
    return reinterpret_cast<jlong>(tx);
}
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_Wallet_disposeTransaction(JNIEnv *env, jobject instance,
                                                          jobject pendingTransaction) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    Bitscala::PendingTransaction *_pendingTransaction =
            getHandle<Bitscala::PendingTransaction>(env, pendingTransaction);
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_getHistoryJ(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_Wallet_setListenerJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_scala_vault_model_Wallet_getDefaultMixin(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return wallet->defaultMixin();
}

JNIEXPORT void JNICALL
Java_com_scala_vault_model_Wallet_setDefaultMixin(JNIEnv *env, jobject instance, jint mixin) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
    return wallet->setDefaultMixin(mixin);
}

JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_Wallet_setUserNote(JNIEnv *env, jobject instance,
...
JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getUserNote(JNIEnv *env, jobject instance,
                                                   jstring txid) {
...
JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getTxKey(JNIEnv *env, jobject instance,
                                                jstring txid) {
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_Wallet_addAccount(JNIEnv *env, jobject instance,
                                                  jstring label) {
...
JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getSubaddressLabel(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_Wallet_setSubaddressLabel(JNIEnv *env, jobject instance,
                                                          jint accountIndex, jint addressIndex,
                                                          jstring label) {
...
JNIEXPORT jint JNICALL
Java_com_scala_vault_model_Wallet_getNumAccounts(JNIEnv *env, jobject instance) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT jint JNICALL
Java_com_scala_vault_model_Wallet_getNumSubaddresses(JNIEnv *env, jobject instance,
                                                          jint accountIndex) {
    Bitscala::Wallet *wallet = getHandle<Bitscala::Wallet>(env, instance);
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_Wallet_addSubaddress(JNIEnv *env, jobject instance,
                                                     jint accountIndex,
                                                     jstring label) {
...
/*JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_Wallet_getLastSubaddress(JNIEnv *env, jobject instance,
                                                         jint accountIndex) {
...
// TransactionHistory
JNIEXPORT jint JNICALL
Java_com_scala_vault_model_TransactionHistory_getCount(JNIEnv *env, jobject instance) {
    Bitscala::TransactionHistory *history = getHandle<Bitscala::TransactionHistory>(env,
                                                                                      instance);
...
jobject newTransferList(JNIEnv *env, Bitscala::TransactionInfo *info) {
    const std::vector<Bitscala::TransactionInfo::Transfer> &transfers = info->transfers();
    ...
    for (const Bitscala::TransactionInfo::Transfer &s: transfers) {
...
jobject newTransactionInfo(JNIEnv *env, Bitscala::TransactionInfo *info) {
    ...
    if (info->direction() == Bitscala::TransactionInfo::Direction_In)
...
jobject cpp2java(JNIEnv *env, std::vector<Bitscala::TransactionInfo *> vector) {
    ...
    for (Bitscala::TransactionInfo *s: vector) {
...
JNIEXPORT jobject JNICALL
Java_com_scala_vault_model_TransactionHistory_refreshJ(JNIEnv *env, jobject instance) {
    Bitscala::TransactionHistory *history = getHandle<Bitscala::TransactionHistory>(env,
                                                                                      instance);
    history->refresh();
...
JNIEXPORT jint JNICALL
Java_com_scala_vault_model_PendingTransaction_getStatusJ(JNIEnv *env, jobject instance) {
    Bitscala::PendingTransaction *tx = getHandle<Bitscala::PendingTransaction>(env, instance);
    return tx->status();
}

JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_PendingTransaction_getErrorString(JNIEnv *env, jobject instance) {
    Bitscala::PendingTransaction *tx = getHandle<Bitscala::PendingTransaction>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_com_scala_vault_model_PendingTransaction_commit(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_PendingTransaction_getAmount(JNIEnv *env, jobject instance) {
    Bitscala::PendingTransaction *tx = getHandle<Bitscala::PendingTransaction>(env, instance);
    return tx->amount();
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_PendingTransaction_getDust(JNIEnv *env, jobject instance) {
    Bitscala::PendingTransaction *tx = getHandle<Bitscala::PendingTransaction>(env, instance);
    return tx->dust();
}

JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_PendingTransaction_getFee(JNIEnv *env, jobject instance) {
    Bitscala::PendingTransaction *tx = getHandle<Bitscala::PendingTransaction>(env, instance);
    return tx->fee();
}
...
JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_PendingTransaction_getFirstTxIdJ(JNIEnv *env, jobject instance) {
    Bitscala::PendingTransaction *tx = getHandle<Bitscala::PendingTransaction>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_scala_vault_model_PendingTransaction_getTxCount(JNIEnv *env, jobject instance) {
    Bitscala::PendingTransaction *tx = getHandle<Bitscala::PendingTransaction>(env, instance);
    return tx->txCount();
}


// these are all in Bitscala::Wallet - which I find wrong, so they are here!
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_WalletManager_initLogger(JNIEnv *env, jclass clazz,
                                                         jstring argv0,
    ...
    Bitscala::Wallet::init(_argv0, _default_log_base_name);
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_WalletManager_logDebug(JNIEnv *env, jclass clazz,
    ...
    Bitscala::Wallet::debug(_category, _message);
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_WalletManager_logInfo(JNIEnv *env, jclass clazz,
                                                      jstring category, jstring message) {

    const char *_category = env->GetStringUTFChars(category, NULL);
    const char *_message = env->GetStringUTFChars(message, NULL);

    Bitscala::Wallet::info(_category, _message);
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_WalletManager_logWarning(JNIEnv *env, jclass clazz,
                                                         jstring category, jstring message) {

    const char *_category = env->GetStringUTFChars(category, NULL);
    const char *_message = env->GetStringUTFChars(message, NULL);

    Bitscala::Wallet::warning(_category, _message);
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_WalletManager_logError(JNIEnv *env, jclass clazz,
                                                       jstring category, jstring message) {

    const char *_category = env->GetStringUTFChars(category, NULL);
    const char *_message = env->GetStringUTFChars(message, NULL);

    Bitscala::Wallet::error(_category, _message);
...
JNIEXPORT void JNICALL
Java_com_scala_vault_model_WalletManager_setLogLevel(JNIEnv *env, jclass clazz,
                                                          jint level) {
    Bitscala::WalletManagerFactory::setLogLevel(level);
}

JNIEXPORT jstring JNICALL
Java_com_scala_vault_model_WalletManager_scalaVersion(JNIEnv *env, jclass clazz) {
